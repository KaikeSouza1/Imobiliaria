    ...
    <main className="min-h-screen bg-white font-sans">
      ...
      <section className="relative h-[400px] w-full flex items-center justify-center">
        ...
        <div className="relative z-10 text-center text-white px-4">
          <h1 className="text-4xl md:text-6xl font-extrabold mb-4 tracking-tight">Quem Somos</h1>
      ...
      <section className="max-w-7xl mx-auto px-4 py-20">
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          ...
          <div className="flex-1 space-y-6">
            ...
            <div className="pt-4">
              <Link
                href="https://api.whatsapp.com/send?phone=5542999755493&text=Ol%C3%A1!%20Gostaria%20de%20falar%20com%20um%20especialista."
                target="_blank"
                className="inline-block bg-[#0f2e20] text-white px-8 py-4 rounded-full font-bold hover:bg-green-800 transition-all shadow-lg hover:shadow-green-900/20 transform hover:-translate-y-1"
              >
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white p-8 rounded-2xl shadow-sm hover:shadow-xl transition-shadow border border-gray-100 group">
              ...
              <p className="text-gray-500 text-sm">Anos de atuação pautados pela ética e respeito em cada negociação realizada.</p>
            </div>
            <div className="bg-white p-8 rounded-2xl shadow-sm hover:shadow-xl transition-shadow border border-gray-100 group">
              <div className="w-14 h-14 bg-green-100 rounded-xl flex items-center justify-center text-green-700 mb-6 group-hover:bg-green-600 group-hover:text-white transition-colors">
              ...
              <p className="text-gray-500 text-sm">Transparência e honestidade são os pilares que sustentam todos os nossos contratos.</p>
            </div>
            <div className="bg-white p-8 rounded-2xl shadow-sm hover:shadow-xl transition-shadow border border-gray-100 group">
              <div className="w-14 h-14 bg-green-100 rounded-xl flex items-center justify-center text-green-700 mb-6 group-hover:bg-green-600 group-hover:text-white transition-colors">
                <Users size={28} />
              ...
              <p className="text-gray-500 text-sm">Consultoria personalizada para entender e atender exatamente o que você busca.</p>
            </div>
            <div className="bg-white p-8 rounded-2xl shadow-sm hover:shadow-xl transition-shadow border border-gray-100 group">
              <div className="w-14 h-14 bg-green-100 rounded-xl flex items-center justify-center text-green-700 mb-6 group-hover:bg-green-600 group-hover:text-white transition-colors">
                <TrendingUp size={28} />
              ...
              <p className="text-gray-500 text-sm">As melhores oportunidades de investimento da região passam por aqui.</p>
            </div>
          </div>
        </div>
      </section>
