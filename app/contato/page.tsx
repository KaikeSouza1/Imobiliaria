...
import { MapPin, Phone, Mail, Instagram, Send, MessageCircle, Clock, CheckCircle2, Loader2 } from "lucide-react";
...
export default function ContatoPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!form.nome.trim() || !form.telefone.trim() || !form.mensagem.trim()) {
      setErro("Por favor, preencha nome, telefone e mensagem.");
      return;
    }
    ...
    try {
      ...
      if (res.ok) {
        setEnviado(true);
        setForm({ nome: "", telefone: "", email: "", assunto: "Tenho interesse em um imóvel", mensagem: "" });
      } else {
    ...
    <main className="min-h-screen bg-slate-50 font-sans pb-20">
      ...
      <section className="relative h-[300px] w-full flex items-center justify-center">
        ...
        <div className="relative z-10 text-center text-white px-4">
          <h1 className="text-4xl md:text-5xl font-extrabold mb-4 tracking-tight">Fale Conosco</h1>
          ...
          <div className="bg-[#0f2e20] text-white p-10 lg:p-14 lg:w-2/5 flex flex-col justify-between relative overflow-hidden">
            ...
            <div>
              ...
              <p className="text-green-100 mb-10 leading-relaxed">
                Tem alguma dúvida sobre um imóvel ou quer agendar uma visita? Nossa equipe está à
                disposição para ajudar você a realizar o melhor negócio.
              </p>
            ...
            {enviado ? (
              ...
              <div className="h-full flex flex-col items-center justify-center text-center py-20">
                ...
                <p className="text-gray-500 max-w-sm leading-relaxed mb-8">
                  Recebemos seu contato e entraremos em touch o mais breve possível. Normalmente respondemos em até 24h.
                </p>
                <button
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="group">
                      ...
                      <input
                        ...
                        required
                        className="w-full p-3 bg-slate-50 border border-gray-200 rounded-xl outline-none focus:border-green-500 focus:bg-white transition-all"
                  ...
                  <div className="group">
                    ...
                    <select
                      ...
                      value={form.assunto}
                      onChange={handleChange}
                      className="w-full p-3 bg-slate-50 border border-gray-200 rounded-xl outline-none focus:border-green-500 focus:bg-white transition-all cursor-pointer text-gray-600"
                    >
                  ...
                  <div className="group">
                    ...
                    <textarea
                      ...
                      onChange={handleChange}
                      required
                      className="w-full p-3 bg-slate-50 border border-gray-200 rounded-xl outline-none focus:border-green-500 focus:bg-white transition-all resize-none"
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full bg-[#0f2e20] hover:bg-green-800 disabled:bg-gray-400 text-white font-bold py-4 rounded-xl shadow-lg transition-all transform active:scale-95 flex items-center justify-center gap-2"
                  >
                    {loading ? (
